...
const Banner = () => {
  return (
    <div className="max-w-[95%] md:w-11/12 mx-auto min-h-162.5 flex items-center justify-center mt-5">
      <div className="flex flex-col md:grid md:grid-cols-12 items-center space-y-20 gap-0 md:gap-10">
        <div className="text-center md:text-start col-span-7 items-center space-y-5">
          ...
          <p className="max-w-122 text-gray-500">
        ...
        <div className="col-span-5 w-full max-[768px]:h-100">
          <img src={bannerImg} alt="banner image" className="w-full overflow-hidden"/>
        </div>
      </div>
    </div>
  );
